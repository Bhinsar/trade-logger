    ...
    <div className="flex items-center justify-between px-4 py-3 border-t border-white/8 bg-white/[0.015]">
      ...
      <div className="flex items-center gap-1.5">
        <Button
          ...
          className="border-white/10 bg-white/5 hover:bg-white/10 text-[#c8ccd8] disabled:opacity-30"
        >
        ...
        {visiblePages.map((pg) => (
          <button
            ...
            className={cn(
              "size-7 rounded-lg text-xs font-semibold transition-all duration-150",
              pg === page
